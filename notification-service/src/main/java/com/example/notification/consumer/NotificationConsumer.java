...
public class NotificationConsumer {
    ...
    public void consumePaymentSuccessNotification(PaymentConfirmation conf)
        ...
        notificationRepository.save(Notification.builder()
                ...
                .notificationDate(LocalDateTime.now()).paymentConfirmation(conf).build());
        // TODO : send email
        var customerName = conf.getCustomerFirstname() + " " + conf.getCustomerLastname();
        emailService.sendPaymentSuccessEmail(conf.getCustomerEmail(), customerName,
                conf.getAmount(), conf.getOrderReference());
    ...
    public void consumeOrderConfirmationNotification(OrderConfirmation conf)
        ...
        notificationRepository.save(Notification.builder()
                ...
                .notificationDate(LocalDateTime.now()).orderConfirmation(conf).build());
        // TODO : send email
